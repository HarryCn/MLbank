#!/usr/bin/env bash
#使用前请备份数据，本脚本免费提供，造成的损失概不负责。
#
# Auto install latest kernel for TCP BBR
#
# 系统要求:  CentOS 6+, Debian7+, Ubuntu12+
#
# Copyright (C) 2016-2017 wzlink QQ34731272
#
# URL: blog.wzlink.win
#
...
echo "---------------------系统信息--------------------------"
echo " 				系统 : $opsy"
echo " 				版本 : $arch ($lbit Bit)"
echo " 				内核 : $kern"
echo "-------------------------------------------------------"
echo "          一键更新内核并且安装bbr加速脚本              "
echo
echo "     			 blog.wzlink.win                         "
echo
echo " 			伸手党请按Ctrl+C 退出，喷子勿使用。	    	 "
echo
echo " 使用前请备份数据，本脚本免费提供，造成的损失概不负责。"
echo
echo "---------------------QQ34731272------------------------"
echo
echo " 回车开始..或者 按Ctrl+C 取消"
char=`get_char`
